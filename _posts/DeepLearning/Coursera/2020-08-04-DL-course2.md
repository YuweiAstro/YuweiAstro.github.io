...
<center>
<video width="620" height="440" src="img/post-img/20200804/dropout1_kiank.mp4" type="video/mp4" controls>
</video>
</center>
<br>
...
3. for each $i$, let $\mathrm{d}\Theta_{approx}^{[i]} = \frac{J(\Theta_1, \dots, \Theta_i + \epsilon, \dots) - J(\Theta_1, \dots, \Theta_i, \dots)}{2\epsilon}$, which is the approximation of $\frac{\part J}{\part \Theta_i}$
...
![batchesCMP](img/post-img/20200804/batches_comparison.jpg)
...
![momentum](https://tva1.sinaimg.cn/large/007S8ZIlly1ghew20j4uij310o0eowho.jpg)
...
|                                                              |                                                              |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| ![opt1](https://tva1.sinaimg.cn/large/007S8ZIlly1ghewa0ccyrg30h80dc1ca.gif) | ![opt2](https://tva1.sinaimg.cn/large/007S8ZIlly1ghewah17mdg30h80dc4n1.gif) |
...
![OneHot](https://tva1.sinaimg.cn/large/007S8ZIlly1ghewuemu1lj31a80bcjud.jpg)
